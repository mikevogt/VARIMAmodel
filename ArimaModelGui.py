...
class instructions(QMainWindow):
    ...
    def initUi(self):
        ...
        self.htmlstep1.setAlignment(Qt.AlignCenter)
        self.empty1 = QtWidgets.QLabel(" ")
        ...
        self.htmlstep2.setAlignment(Qt.AlignCenter)
        ...
        self.htmlstep3.setAlignment(Qt.AlignCenter)
